            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    ...
                    margin-left: 25px;" src="{{ asset('assets/images/logo.svg') }}" alt="logo" />
                        ...
                        <form class="forms-sample mb-5" method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input required type="nama" name="nama"
                                    class="form-control @error('nama') is-invalid @enderror" id="nama"
                                    placeholder="Nama" autocomplete="nama" autofocus value="{{ old('nama') }}">
                                @error('nama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <a class="btn btn-link text-decoration-none" href="{{ route('login') }}">
                                <div class="text-muted">Sudah punya akun ? Login</div>
                            </a>
                            @endif
                        </form>
                    </div>
